...
@section('sub-title',' إضافة مجموعة  ')

@section('active title',' إضافة مجموعة ')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="group_name" class="form-control" id="group_name" placeholder="أدخل اسم المجموعة">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="group_number">رقم المجموعة</label>
                                    <input type="text" name="group_number" class="form-control" id="group_number" placeholder="أدخل رقم المجموعة">
                                </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{route('groups.index')}}"><button type="button" class="btn btn-lg btn-primary"> قائمة المجموعات </button></a>

                                {{-- <a href="{{route('indexGroup' , $id)}}"><button type="button" class="btn btn-lg btn-primary"> قائمة المجموعات </button></a> --}}
...
<script>
    function performStore() {
        ...
        store('/cms/admin/groups', formData);
