...
@section('sub-title',' إضافة قاعة  ')

@section('active title',' إضافة بيانات القاعة ')
@section('styles')
                      ...
                      <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="room_number" class="form-control" id="room_number"
                                    placeholder="أدخل رقم واسم القاعة">
                            </div>
                        ...
                        <div class="form-group col-md-4">
                            <label for="from">موعد بداية المحاضرة</label>
                        ...
                        <div class="form-group col-md-4">
                            <label for="to">موعد نهاية المحاضرة</label>
