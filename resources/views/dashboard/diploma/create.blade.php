...
@section('sub-title',' إضافة دبلومة  ')

@section('active title',' تعديل بيانات الدبلومة ')
@section('styles')
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">عرض بيانات الدبلومة</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="create_form">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name"
                                        placeholder="أدخل اسم الدبلومة">
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="trannig_type">نوع الدبلومة</label>
                                    <select class="form-select form-select-sm" name="trannig_type" style="width: 100%;"
                                        id="trannig_type" aria-label=".form-select-sm example">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="number_of_hours" class="form-control" id="number_of_hours"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="number_of_student" class="form-control"
                                        id="number_of_student" placeholder="ادخل عدد الطلاب  ">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="price" class="form-control" id="price"
                                        placeholder="ادخل رسوم الدبلومة  ">
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-select form-select-sm" name="currency" style="width: 100%;"
                                        id="currency" aria-label=".form-select-sm example">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-select form-select-sm" name="room_id" style="width: 100%;"
                                        id="room_id" aria-label=".form-select-sm example">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="description"> وصف الدبلومة</label>
...
$('.room_id').select2({
    ...
    function performStore() {
        ...
        store('/cms/admin/diplomas',formData);
