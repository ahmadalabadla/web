            ...
            <table class="table table-hover table-bordered table-striped text-nowrap text-center">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  {{-- <td>{{$diploma->who}}</td> --}}
                  {{-- <td>
                    <img class="img-circle img-bordered-sm" src="{{asset('images/diploma_who/'.$diploma->image_who)}}" width="60" height="60" alt="User Image">
                  </td> --}}
                   <td>{{$diploma->name}}</td>
                  <td>{{$diploma->price}}</td>
                  <td><span class="badge bg-success"> {{$diploma->status}}</span></td>
