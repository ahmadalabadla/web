...
@section('left-title','عرض ملفات المساق ')

@section('active title','عرض ملفات المساق ')
            ...
            <div class="card-tools">
                <form action="" method="get" >
                    ...
                    <div >
                          ...
                          {{-- <a href="{{route('indexCourse' , $id)}}"  class="btn btn-danger"> قائمة المساقات</a> --}}
                ...
                {{-- <a href="{{ route('indexCourse' , $id) }}" class="btn btn-primary" style="color: white;"> عودة للمساقات </a> --}}
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn">
                      {{-- @can('Edit-City') --}}
                      <a href="{{route('fileCourses.edit', $file->id)}}" class="btn btn-info" title="Edit">
                        تعديل
                        </a>
                      {{-- @endcan --}}
                      {{-- @can('Delete-City') --}}
                     ...
                     <a href="{{ asset('storage/files/cources/'. $file->file) }}"
...
@section('scripts')
 ...
 <script>
  function performDestroy(id, reference){
    let url = '/cms/admin/fileCourses/'+id;
