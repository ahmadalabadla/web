...
Route::prefix('cms/admin/')->middleware('auth:admin')->group(function(){
    ...
    Route::get('/index-student/{id}', [StudentController::class, 'indexStudent'])->name('indexStudent');
    ...
    Route::get('/create/trainer_evalutions/{id}', [TrainerEvaluationController::class, 'createTrainer'])->name('createTrainer');
    Route::get('/index/trainer_evalutions/{id}', [TrainerEvaluationController::class, 'indexTrainer'])->name('indexTrainer');
