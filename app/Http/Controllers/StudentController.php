...
class StudentController extends Controller
{
    ...
    public function indexStudent(Request $request , $id){
    ...
    public function index(Request $request)
    {
        ...
        return response()->view('dashboard.student.index',compact('students'));
    }
    ...
    public function create()
    {
        ...
        return response()->view('dashboard.student.create',compact('cities','groups','finances' , 'diplomas'));
    }
